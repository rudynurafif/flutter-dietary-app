    ...
    return Column(
      ...
      children: [
        const Padding(
          ...
          child: Text('Popular', style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.w600)),
        ),
        const SizedBox(
          height: 15,
        ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: const TextStyle(color: Color(0xff786F72), fontSize: 13, fontWeight: FontWeight.w400),
                      )
                    ],
                  ),
                  GestureDetector(
